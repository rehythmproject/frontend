...
import { useContext, useState,checkPhone } from 'react';
...
const ThirdSignup = () => {
  ...
  const validatePhoneNumber = (phone) => {
    ...
    return phonePattern.test(signData.phone);
  };
  ...
  const sendPhoneNumber = () => {
    ...
    else if(signData.phone.length < 11){
      alert('휴대번호를 확인해주세요.');
      console.log(signData.phone.length);
      return;
    } else if(!validatePhoneNumber(signData.phone)) {
  ...
  return (
    <div className="third_signup">
          <div className='sign_input'>
            ...
            <input type="tel" id='phone' className='signup_input' placeholder='ex) 01000000000' maxLength={11} onChange={handlePhone} value={signData.phone}/>
